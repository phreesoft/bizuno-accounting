...
if (!defined('PDF_FONT_NAME_MAIN')) { define ('PDF_FONT_NAME_MAIN', \bizuno\getModuleCache('phreeform','settings','general','default_font','helvetica')); }
/**
 * Installation path (/var/www/tcpdf/).
 * By default it is automatically calculated but you can also set it as a fixed string to improve performances.
 */
if (!defined('K_PATH_MAIN')) { define ('K_PATH_MAIN', BIZUNO_3P_PDF); }

/**
 * URL path to tcpdf installation folder (http://localhost/tcpdf/).
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
if (!defined('K_PATH_URL')) { define ('K_PATH_URL', BIZUNO_3P_PDF); }
...
if (!defined('K_PATH_XFONTS')) { define ('K_PATH_XFONTS', BIZBOOKS_LOCALE.'../fonts-pdf/TCPDF/fonts/'); }
