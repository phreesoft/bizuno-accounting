...
class open_j03
{
    ...
    function __construct($settings)
    {
        ...
        $defaults      = ['jID'=>3,'max_rows'=>20,'users'=>'-1','roles'=>'-1','reps'=>'0','num_rows'=>5,'limit'=>1,'order'=>'desc'];
    ...
    public function settingsStructure()
    {
        return [
            ...
            'limit'   => ['order'=>20,'break'=>true,'position'=>'after','label'=>lang('hide_future'),'values'=>viewKeyDropdown($this->noYes),'attr'=>['type'=>'select','value'=>$this->settings['limit']]],
